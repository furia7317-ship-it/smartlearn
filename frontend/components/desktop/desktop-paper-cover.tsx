...
export function DesktopPaperCover({
  paper,
  onOpen,
  onDelete,
}: {
  ...
  return (
    <button
      ...
      className="group relative flex flex-col overflow-hidden rounded-2xl border bg-card text-left transition-colors hover:border-primary/40"
    >
      ...
      <div className="flex flex-1 flex-col items-center px-4 py-7 text-center">
        <div className="font-display text-sm tracking-wide text-muted-foreground">
          《{paper.topic || "综合"}》
        </div>
        <h3 className="mt-1.5 line-clamp-2 font-display text-[17px] font-semibold leading-snug">
